...
export type StringsShape = {
  ...
  scan: {
    ...
    back: string;
    back_a11y: string;
    answered_suffix: string;
    scale_low: string;
    scale_high: string;
    tap_answer: string;
    see_archetype: string;
    continue: string;
    reading: string;
    strengths: string;
    growth: string;
    ...
    q1_category: string; q1_text: string;
    q2_category: string; q2_text: string;
    q3_category: string; q3_text: string;
    q4_category: string; q4_text: string;
    q5_category: string; q5_text: string;
    q6_category: string; q6_text: string;
    q7_category: string; q7_text: string;
    q8_category: string; q8_text: string;
    q9_category: string; q9_text: string;
    q10_category: string; q10_text: string;
    q11_category: string; q11_text: string;
    scale_1: string; scale_2: string; scale_3: string; scale_4: string;
    scale_5: string; scale_6: string; scale_7: string;
    protector_name: string; protector_quote: string; protector_description: string;
    protector_strength_1: string; protector_strength_2: string; protector_strength_3: string; protector_strength_4: string;
    protector_growth_1: string; protector_growth_2: string; protector_growth_3: string;
    connector_name: string; connector_quote: string; connector_description: string;
    connector_strength_1: string; connector_strength_2: string; connector_strength_3: string; connector_strength_4: string;
    connector_growth_1: string; connector_growth_2: string; connector_growth_3: string;
    performer_name: string; performer_quote: string; performer_description: string;
    performer_strength_1: string; performer_strength_2: string; performer_strength_3: string; performer_strength_4: string;
    performer_growth_1: string; performer_growth_2: string; performer_growth_3: string;
    disconnector_name: string; disconnector_quote: string; disconnector_description: string;
    disconnector_strength_1: string; disconnector_strength_2: string; disconnector_strength_3: string; disconnector_strength_4: string;
    disconnector_growth_1: string; disconnector_growth_2: string; disconnector_growth_3: string;
  };
  shelf_editor: {
    not_found: string;
    back: string;
    ...
    pii_warning: string;
    clear_error: string;
    save_item_a11y: string;
    add_item_a11y: string;
    saving: string;
    save_anyway: string;
    save_changes: string;
    add_to_shelf: string;
    ...
    remove: string;
    memory_note: string;
    song_a_label: string; song_a_title: string; song_a_detail: string; song_a_detail_placeholder: string;
    song_b_label: string; song_b_title: string; song_b_detail: string; song_b_detail_placeholder: string;
    film_label: string; film_title: string; film_detail: string; film_detail_placeholder: string;
