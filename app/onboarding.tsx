...
function TasteCategories() {
  return (
    <View accessibilityLabel="Taste categories" style={styles.categoryStrip}>
      <View accessibilityRole="button" accessibilityState={{ selected: true }} style={[styles.categoryTile, styles.categoryTileOn]}><Text style={styles.categoryGlyph}>♫</Text><Text style={styles.categoryNameOn}>Music</Text><Text style={styles.categoryStateOn}>AVAILABLE</Text></View>
      <View accessibilityRole="button" accessibilityState={{ disabled: true }} style={styles.categoryTile}><Text style={styles.categoryGlyphQuiet}>▤</Text><Text style={styles.categoryName}>Books</Text><Text style={styles.categoryState}>COMING LATER</Text></View>
      <View accessibilityRole="button" accessibilityState={{ disabled: true }} style={styles.categoryTile}><Text style={styles.categoryGlyphQuiet}>◫</Text><Text style={styles.categoryName}>Films</Text><Text style={styles.categoryState}>COMING LATER</Text></View>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  categoryStrip: { flexDirection: 'row', gap: 9, marginBottom: 16 },
  categoryTile: { flex: 1, minHeight: 108, padding: 12, borderRadius: radius.medium, borderWidth: 1, borderColor: surface.border, backgroundColor: 'rgba(248,242,255,0.018)', opacity: 0.56 },
  categoryTileOn: { opacity: 1, borderColor: cosmos.selectedBorder, backgroundColor: cosmos.selectedFill },
  categoryGlyph: { fontFamily: font.display, fontSize: 26, color: cosmos.lilac },
  categoryGlyphQuiet: { fontFamily: font.display, fontSize: 25, color: ink.faint },
  categoryName: { marginTop: 10, fontFamily: font.bodyStrong, fontSize: 11, color: ink.mid },
  categoryNameOn: { marginTop: 10, fontFamily: font.bodyStrong, fontSize: 11, color: ink.high },
  categoryState: { marginTop: 4, fontFamily: font.bodyStrong, fontSize: 6.5, letterSpacing: 0.8, color: ink.faint },
  categoryStateOn: { marginTop: 4, fontFamily: font.bodyStrong, fontSize: 6.5, letterSpacing: 0.8, color: cosmos.success },
