...
import { ink, font, sky, surface, layout } from '../../src/theme';
...
const styles = StyleSheet.create({
  ...
  matchRow: { backgroundColor: 'rgba(168,155,240,0.05)' },
  art: {
    width: 44,
    height: 44,
    borderRadius: 8,
  ...
  divider: { height: 1, backgroundColor: surface.border, marginTop: 52 },
  matchMoon: { marginTop: 22 },
  matchLine: {
    marginTop: 18,
    fontFamily: font.body,
    fontSize: 15,
